    ...
    <div className="bg-green-800  pt-4 h-screen">
      <div className="flex  rounded-2xl mt-40 w-[60%] items-center h-[60vh]  m-auto">
        ...
        <div className="w-[50%] gap-5 h-[100%] bg-white items-center flex flex-col justify-center">
            <div className='w-[85%] '>
        <h2 class="text-2xl font-bold mb-6 w-full ml-40">Login Admin</h2>
    <form className='  '>
        <div class="mb-4">
        ...
        <div>
            <button type="submit" class="w-full bg-green-500 text-white p-2 rounded-md hover:bg-green-600"><Link to="/adminpage">Login</Link></button>
        </div>
    </form>
    </div>
        </div>
